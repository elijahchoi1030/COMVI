...
def train(model, device, epochs, train_dataloader) :
    ...
    for epoch in range(epochs):
        ...
        print('(Train) [epoch : %d] loss: %.3f | acc: %.3f' % (epoch + 1, avg_loss, accuracy))
